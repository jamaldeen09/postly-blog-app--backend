...
commentRouter.get("/posts/:postId/comments",
    ...
    validationService.newBlogPostValidation("page"),
    expressValidationHandler,
    getBlogPostComments,
);

// ** Add a new comment ** \\
commentRouter.post("/comments/:postId",
    verifyAccessToken,
    validationService.newBlogPostValidation("postId"),
    validationService.newCommentValidation("comment-creation"),
    expressValidationHandler,
    addNewComment
);

// ** Like or unlike a comment ** \\
commentRouter.patch("/comments/:commentId/:postId", 
    verifyAccessToken,
    validationService.newBlogPostValidation("postId"),
    validationService.newCommentValidation("commentId"),
    expressValidationHandler,
