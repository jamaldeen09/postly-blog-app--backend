...
const getCreatedBlogPosts = async (req, res) => {
    try {
...
const getLikedBlogPosts = async (req, res) => {
    try {
...
const getArchivedBlogPosts = async (req, res) => {
    try {
...
const likeOrUnlikeBlogPost = async (req, res) => {
    try {
        ...
        const typedRequestedPost = updatedBlogPost;
        const mutatedPost = {
            ...typedRequestedPost,
...
const getSingleBlogPost = async (req, res) => {
    try {
        ...
        if (!cachedPost) {
            ...
            const requestedPost = await BlogPost.findById(postId)
                .lean()
                .select("_id author category title content comments likes views createdAt updatedAt isArchived")
                .populate({ path: "author", model: "User", select: "_id username" });
            if (!requestedPost)
            ...
            const typedRequestedPost = requestedPost;
            const mutatedPost = {
                ...typedRequestedPost,
...
const newBlogPostView = async (req, res) => {
    try {
        ...
        const updatedPost = await BlogPost.findByIdAndUpdate(postBeingViewed._id, {
...
const archiveOrUnarchiveBlogPost = async (req, res) => {
    try {
        ...
        let updatedBlogPost = await BlogPost.findByIdAndUpdate(postBeingArchived._id, {
        ...
        const typedUpdatedBlogPost = updatedBlogPost;
        const mutatedPost = {
...
//# sourceMappingURL=blogPost.controllers.js.map