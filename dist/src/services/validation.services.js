...
class ValidationHandler {
    ...
    newAuthValidation(validationPurpose) {
            ...
            return [
                ...
                body("username")
                    ...
                    try {
                        ...
                        if (user)
                            throw new Error("A user with that username already exists please use another one");
    ...
    ;
    newBlogPostValidation(validationPurpose) {
    ...
    ;
    newCommentValidation(validationPurpose) {
